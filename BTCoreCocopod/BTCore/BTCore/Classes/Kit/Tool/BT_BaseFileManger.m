...
@interface BT_BaseFileManger()
@property (strong, nonatomic) NSFileManager *manager;
@end

@implementation BT_BaseFileManger

#pragma mark - 获取硬盘空间及剩余可用空间
...
+ (NSString *)tmpVideoDir {
    NSString *libraryDir = [self documentsDir];
    return [libraryDir stringByAppendingPathComponent:@"DWDownloadCache"];
