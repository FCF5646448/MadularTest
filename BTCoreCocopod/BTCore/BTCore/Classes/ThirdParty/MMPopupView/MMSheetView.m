...
- (instancetype)initWithTitle:(NSString *)title items:(NSArray *)items
{
    ...
    if ( self )
    {
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            [btn setTitleColor:[config colorForType:item] forState:UIControlStateNormal];
...
- (UIColor *)colorForType:(MMPopupItem *)item{
    switch (item.type) {
        case MMItemTypeNormal:
            return self.itemNormalColor;
        case MMItemTypeHighlight:
            return self.itemHighlightColor;
        case MMItemTypeDanger:
            return self.itemDangerColor;
        case MMItemTypeDisabled:
            return self.itemDisableColor;
        default:
            return self.itemNormalColor;
            break;
    }
