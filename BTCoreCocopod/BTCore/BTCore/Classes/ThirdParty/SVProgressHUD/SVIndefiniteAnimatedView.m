...
//        _indefiniteAnimatedLayer.path = smoothedPath.CGPath;
        ...
        NSString *path = [bundle pathForResource:@"loading@2x" ofType:@"png"];
...
//        NSString *path = [imageBundle pathForResource:@"angle-mask" ofType:@"png"];
        ...
        maskLayer.frame = CGRectMake(0.0f, 0.0f, arcCenter.x, arcCenter.y);
        _indefiniteAnimatedLayer = maskLayer;
